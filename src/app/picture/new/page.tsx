            ...
            <div className="flex flex-col items-center">
                <div className='bg-gray-100 flex flex-col items-center p-6'>
                    ...
                    <form className="flex flex-col gap-2 w-[500px]">
                        <label className='mb-[-7px] mt-3' htmlFor="pictureDate">Picture Date</label>
                        <input type="date" name="pictureDate" className='p-1'></input>
                        <label className='mb-[-7px] mt-3' htmlFor="attachedMemory">Attached Memory</label>
                        <input type="text" name="attachedMemory" className='p-1'></input>
                        <label htmlFor="pictures" className='mb-[-7px] mt-3'>Pictures</label>
                        <AttachedImages />
